    ...
    <v-row>
      ...
      <v-col col="12" md="10" lg="8" xl="6" align="center">
        <v-card align="start" class="white rounded-xl mx-2 mt-4" flat>
          ...
          <p id="bF">
            Your privacy is important to us. It is IV-CODE' policy to respect
          ...
          <p id="bF">
            This policy is effective as of 1 November 2022 and was last updated
            on 1 November 2022.
          </p>
          <p id="hF" class="text-h6 pt-7">Information We Collect</p>
          <p id="bF">
          ...
          <p id="hF" class="text-h6 pt-7">Log Data</p>
          <p id="bF">
          ...
          <p id="hF" class="text-h6 pt-7">Personal Information</p>
          <p id="bF">
          ...
          <p id="hF" class="text-h6 pt-7">Collection and Use of Information</p>
          <p id="bF">
          ...
          <p id="hF" class="text-h6 pt-7">Children’s Privacy</p>
          <p id="bF">
          ...
          <p id="bF">We may disclose personal information to:</p>
          <ul id="bF" class="mb-4">
          ...
          <p id="hF" class="text-h6 pt-7">Use of Cookies</p>
          <p id="bF">
          ...
          <p id="hF" class="text-h6 pt-7">Limits of Our Policy</p>
          <p id="bF">
          ...
          <p id="hF" class="text-h6 pt-7">Changes to This Policy</p>
          <p id="bF">
          ...
          <p id="hF" class="text-h6 pt-7">Contact Us</p>
          <p id="bF">
